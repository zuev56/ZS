...
internal abstract class HardwareMonitorOld : IHardwareMonitor
{
    protected readonly HardwareMonitorSettings Options;
    protected readonly ILogger<HardwareMonitorOld> Logger;

    public ProgramJob<string> Job { get; }

    protected HardwareMonitorOld(
        IOptions<HardwareMonitorSettings> options,
        ILogger<HardwareMonitorOld> logger)
    {
